...
exports.ROWS = ROWS;
var GAP_SIZE = 8;
exports.GAP_SIZE = GAP_SIZE;
var CELL_SIZE = 20;
exports.CELL_SIZE = CELL_SIZE;
var CANVAS_WIDTH = COLS * (CELL_SIZE + GAP_SIZE);
exports.CANVAS_WIDTH = CANVAS_WIDTH;
var CANVAS_HEIGHT = ROWS * (CELL_SIZE + GAP_SIZE);
exports.CANVAS_HEIGHT = CANVAS_HEIGHT;
var INITIAL_DIRECTION = {
  x: 1,
  y: 0
};
exports.INITIAL_DIRECTION = INITIAL_DIRECTION;
var SNAKE_LENGTH = 20;
exports.SNAKE_LENGTH = SNAKE_LENGTH;
var POINTS_PER_APPLE = 2;
exports.POINTS_PER_APPLE = POINTS_PER_APPLE;
var SPEED = 100;
exports.SPEED = SPEED;
var APPLES_COUNT = 5;
exports.APPLES_COUNT = APPLES_COUNT;

var createCanvasElement = function createCanvasElement() {
...
var nextPosition = function nextPosition(prev, next) {
  var isOpposite = function isOpposite(previous, next) {
...
var snakeDraw = function snakeDraw(ctx, snake) {
  snake.forEach(function (point, index) {
    ctx.beginPath();
...
exports.snakeDraw = snakeDraw;

var applesDraw = function applesDraw(ctx, apples) {
  apples.forEach(function (point, index) {
    ctx.beginPath();
...
exports.applesDraw = applesDraw;

var cleanCanvas = function cleanCanvas(ctx) {
  ctx.clearRect(0, 0, canvas.width, canvas.height);
};

var move = function move(snake, _a) {
  var direction = _a[0],
      snakeLength = _a[1];
  var nx = snake[0].x;
  var ny = snake[0].y;
...
var generateApples = function generateApples() {
  var apples = [];

  for (var i = 0; i < APPLES_COUNT; i++) {
...
exports.generateApples = generateApples;
...
var eat = function eat(apples, snake) {
  var snakeHead = snake[0];
  apples.forEach(function (apple, index) {
    if (isColliding(apple, snakeHead)) {
      apples.splice(index, 1);
      apples = __spreadArrays(apples, [randomPoint()]);
    }
  });
  return apples;
};
...
var isColliding = function isColliding(p1, p2) {
  return p1.x === p2.x && p1.y === p2.y;
};

exports.isColliding = isColliding;

var isGameOver = function isGameOver(scene) {
  var snake = scene.snake;
  var head = snake[0];
  var body = snake.slice(1, snake.length);
  return body.some(function (segment) {
    return isColliding(segment, head);
  });
};
...
var direction$ = keydown$.pipe((0, _operators.map)(function (event) {
  return DIRECTIONS[event.keyCode];
}), (0, _operators.filter)(function (direction) {
  return !!direction;
}), (0, _operators.scan)(nextPosition), (0, _operators.startWith)(INITIAL_DIRECTION), (0, _operators.distinctUntilChanged)());
var length$ = new _rxjs.BehaviorSubject(SNAKE_LENGTH);
var snakeLength$ = length$.pipe((0, _operators.scan)(function (step, snakeLength) {
  return snakeLength + step;
}), (0, _operators.share)());
var score$ = snakeLength$.pipe((0, _operators.startWith)(0), (0, _operators.scan)(function (score, _) {
  return score + POINTS_PER_APPLE;
}));
var ticks$ = (0, _rxjs.interval)(SPEED);
var snake$ = ticks$.pipe((0, _operators.withLatestFrom)(direction$, snakeLength$, function (_, direction, snakeLength) {
  return [direction, snakeLength];
}), (0, _operators.scan)(move, generateSnake()), (0, _operators.share)());
var apples$ = snake$.pipe((0, _operators.scan)(eat, generateApples()), (0, _operators.distinctUntilChanged)(), (0, _operators.share)());
var applesEaten$ = apples$.pipe((0, _operators.skip)(1), (0, _operators.tap)(function () {
  return length$.next(1);
})).subscribe();
var scene$ = (0, _rxjs.combineLatest)(snake$, apples$, function (snake, apples) {
  return {
    snake: snake,
    apples: apples
  };
});
scene$.pipe((0, _operators.takeWhile)(function (scene) {
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","snake/js/index.ts"], null)
//# sourceMappingURL=/js.1273259c.js.map