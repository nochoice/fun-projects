...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node_modules/rxjs/internal/util/isArray.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../node_modules/rxjs/internal/util/isFunction.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Subscription":"../../node_modules/rxjs/internal/Subscription.js"}],"../../node_modules/rxjs/internal/scheduler/AsyncAction.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./Action":"../../node_modules/rxjs/internal/scheduler/Action.js"}],"../../node_modules/rxjs/internal/scheduler/AnimationFrameAction.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./AsyncAction":"../../node_modules/rxjs/internal/scheduler/AsyncAction.js"}],"../../node_modules/rxjs/internal/Scheduler.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{}],"../../node_modules/rxjs/internal/scheduler/AsyncScheduler.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../Scheduler":"../../node_modules/rxjs/internal/Scheduler.js"}],"../../node_modules/rxjs/internal/scheduler/AnimationFrameScheduler.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./AsyncScheduler":"../../node_modules/rxjs/internal/scheduler/AsyncScheduler.js"}],"../../node_modules/rxjs/internal/scheduler/animationFrame.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./AnimationFrameAction":"../../node_modules/rxjs/internal/scheduler/AnimationFrameAction.js","./AnimationFrameScheduler":"../../node_modules/rxjs/internal/scheduler/AnimationFrameScheduler.js"}],"../../node_modules/tslib/tslib.es6.js":[function(require,module,exports) {
"use strict";
...
},{"../Subscriber":"../../node_modules/rxjs/_esm5/internal/Subscriber.js","../symbol/rxSubscriber":"../../node_modules/rxjs/_esm5/internal/symbol/rxSubscriber.js","../Observer":"../../node_modules/rxjs/_esm5/internal/Observer.js"}],"../../node_modules/rxjs/_esm5/internal/util/identity.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"../../node_modules/tslib/tslib.es6.js","../Subscriber":"../../node_modules/rxjs/_esm5/internal/Subscriber.js"}],"../../node_modules/rxjs/_esm5/internal/util/noop.js":[function(require,module,exports) {
"use strict";
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
function noop() {}
},{}],"../../node_modules/rxjs/_esm5/internal/operators/tap.js":[function(require,module,exports) {
"use strict";
...
var appendCanvas = function appendCanvas(place, canvas) {
  place.appendChild(canvas);
};

exports.appendCanvas = appendCanvas;

var getCtx = function getCtx(canvas) {
...
var canvas = _interopRequireWildcard(require("./js/canvas"));

function _getRequireWildcardCache() { if (typeof WeakMap !== "function") return null; var cache = new WeakMap(); _getRequireWildcardCache = function () { return cache; }; return cache; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }

var c = canvas.createCanvas(900, 400);
canvas.appendCanvas(document.body, c);
var ctx = canvas.getCtx(c);
var DIRECTIONS = {
  37: -1,
  39: 1
};
var keyPress$ = (0, _rxjs.merge)((0, _rxjs.fromEvent)(document, 'keydown').pipe((0, _operators.map)(function (e) {
  return DIRECTIONS[e.keyCode];
}), (0, _operators.filter)(function (dir) {
  return !!dir;
})), (0, _rxjs.fromEvent)(document, 'keyup').pipe((0, _operators.map)(function () {
  return 0;
...
var ticker$ = (0, _rxjs.interval)(0, _animationFrame.animationFrame); // .pipe(take(10)); 

var paddleSpeed$ = new _rxjs.BehaviorSubject(1);
var paddleSize$ = new _rxjs.BehaviorSubject(100);
var paddleMove$ = ticker$.pipe((0, _operators.withLatestFrom)(keyPress$, paddleSpeed$, paddleSize$), (0, _operators.scan)(function (paddle, _a) {
  var _ = _a[0],
      direction = _a[1],
      speed = _a[2],
      size = _a[3];
...
var ballMove$ = ticker$.pipe((0, _operators.scan)(function (ball, a) {
...
var ballCollisionBorder = function ballCollisionBorder(ball) {
...
var draw = function draw(ball, paddle) {
  cleanCanvas(ctx);
  drawBall(ball);
  drawPaddle(paddle);
};

var cleanCanvas = function cleanCanvas(ctx) {
...
var drawPaddle = function drawPaddle(paddle) {
  ctx.beginPath();
  var posX = paddle.x / 100 * c.width;
  ctx.fillRect(posX - paddle.size / 2, 50, paddle.size, 15);
  ctx.fillStyle = 'green';
};

(0, _rxjs.combineLatest)(ticker$, paddleMove$, ballMove$).pipe((0, _operators.tap)(function (_a) {
  var _ = _a[0],
      paddle = _a[1],
      ball = _a[2];
  draw(ball, paddle);
})).subscribe(); // ticker$.pipe(
//     withLatestFrom(keyPress$),
//     tap((a: any) => console.log(a))
// ).subscribe();
},{"rxjs/internal/scheduler/animationFrame":"../../node_modules/rxjs/internal/scheduler/animationFrame.js","rxjs/operators":"../../node_modules/rxjs/_esm5/operators/index.js","rxjs":"../../node_modules/rxjs/_esm5/index.js","./js/canvas":"js/canvas.ts"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/playground.77de5100.js.map