...
const fuelRequirementsWithFuel = (mass)  => {
    let total = 0;
    while(mass > 0) {
...
exports.fuelRequirements = fuelRequirements;
exports.fuelRequirementsWithFuel = fuelRequirementsWithFuel;

const sum = (data, strategy) => data.split('\n')
                            .map((x) => +x)
